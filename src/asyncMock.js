export const productos = [
    {id:'1',nombre:'Bordado Premium',precio: 2000,categoria: 'oficios',img:'/images/bordado.png',descripcion:'descripcion bordado',checkout:'https://go.hotmart.com/G76231636V?ap=46c5',stock:10},
...
export const getProductosCategoria = (categoriaId) =>{
    return new Promise((resolve) => {
        setTimeout(() => {
            const filteredProducts = productos.filter((item)=> item.categoria === categoriaId)
